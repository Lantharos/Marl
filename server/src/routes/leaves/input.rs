...
use crate::{features, request_context::Database};
...
async fn unique_slug(
    ...
    let mut counter = 2;
    while features::leaf_slug_exists(database, tenant, project, &slug, existing_id).await? {
