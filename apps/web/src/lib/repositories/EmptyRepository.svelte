...
<style>
  .empty-repository{width:min(780px,100%);padding:24px 0 36px}.empty-repository>header{display:grid;grid-template-columns:38px minmax(0,1fr);align-items:start;gap:13px}.repository-mark{display:grid;width:36px;height:36px;border-radius:8px;background:var(--brand-soft);color:var(--brand);place-items:center}h1{margin:1px 0 0;color:var(--text-strong);font-size:20px;font-weight:660;letter-spacing:-.025em;text-wrap:balance}header p{max-width:620px;margin:6px 0 0;color:var(--text-muted);font-size:11px;line-height:1.55;text-wrap:pretty}.protocols{display:flex;gap:3px;margin:25px 0 10px 51px}.protocols button{height:28px;padding:0 9px;border:0;border-radius:5px;background:transparent;color:var(--text-faint);font:inherit;font-size:11px;font-weight:630;cursor:pointer}.protocols button:hover{background:var(--surface-hover);color:var(--text)}.protocols button.active{background:var(--surface-muted);color:var(--text-strong)}.push-instructions{margin:25px 0 0 51px}.protocols+.push-instructions{margin-top:0}.push-instructions strong,.push-instructions span{display:block}.push-instructions strong{color:var(--text-strong);font-size:12px}.push-instructions span{margin-top:4px;color:var(--text-faint);font-size:11px}.command{position:relative;margin-top:10px}.command pre{overflow-x:auto;margin:0;padding:13px 48px 13px 14px;border-radius:7px;background:var(--surface-muted);color:var(--text);font:11px/1.75 var(--font-mono)}.command :global(.button){position:absolute;top:8px;right:8px}.auth,.read-only{max-width:690px;margin:13px 0 0 51px;color:var(--text-muted);font-size:11px;line-height:1.55;text-wrap:pretty}.auth a{color:var(--brand);font-weight:620;text-decoration:none}.auth a:hover{text-decoration:underline}@media(max-width:600px){.empty-repository{padding-top:12px}.protocols,.push-instructions,.auth,.read-only{margin-left:0}.protocols{margin-top:22px}.command pre{font-size:11px}}
</style>
