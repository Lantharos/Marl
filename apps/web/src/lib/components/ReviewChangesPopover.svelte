...
<style>
  .review-anchor{position:relative;display:flex}.review-popover{position:fixed;z-index:90;display:flex;flex-direction:column;overflow-y:auto;padding:14px;border:1px solid var(--border-strong);border-radius:10px;background:var(--surface-raised);box-shadow:0 18px 54px rgb(0 0 0/.38)}.review-popover>header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:13px}.review-popover>header strong,.review-popover>header span{display:block}.review-popover>header strong{color:var(--text-strong);font-size:13px}.review-popover>header span{margin-top:3px;color:var(--text-faint);font-size:9px}.review-decisions{display:grid;gap:4px;margin-top:10px}.review-decisions :global(.review-choice.button){height:auto;min-height:48px;justify-content:flex-start;padding:8px 9px;text-align:left;white-space:normal}.review-decisions :global(.review-choice.button.active){background:var(--surface-muted);color:var(--text-strong)}.choice-mark{width:14px;height:14px;flex:0 0 auto;border:1px solid var(--border-strong);border-radius:50%;box-shadow:inset 0 0 0 3px transparent}:global(.review-choice.button.active .choice-mark){border-color:var(--brand);background:var(--brand);box-shadow:inset 0 0 0 3px var(--surface-raised)}.choice-copy strong,.choice-copy small{display:block}.choice-copy strong{font-size:10px}.choice-copy small{margin-top:3px;color:var(--text-faint);font-size:8px;line-height:1.4}.review-popover>footer{display:flex;justify-content:flex-end;gap:7px;margin:13px -14px -14px;padding:11px 14px;border-top:1px solid var(--border-subtle);border-radius:0 0 9px 9px;background:var(--surface-muted)}
</style>
