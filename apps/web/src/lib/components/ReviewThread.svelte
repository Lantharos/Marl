...
<style>
  .thread{content-visibility:auto;contain-intrinsic-size:auto 190px;padding:2px 4px 8px}.thread.inline{margin:9px 10px;padding:9px 11px;border-radius:7px;background:var(--surface-raised)}.thread.outdated{opacity:.68}.location{display:flex;min-height:31px;align-items:center;gap:8px}.location strong{overflow:hidden;color:var(--text-strong);font:600 10px ui-monospace,SFMono-Regular,Consolas,monospace;text-overflow:ellipsis;white-space:nowrap}.location>span{color:var(--text-faint);font-size:9px;white-space:nowrap}.thread-actions{display:flex;align-items:center;gap:3px;margin-left:auto}.thread-actions>span{color:var(--warning);font-size:9px}.thread-actions>.resolved{color:var(--success)}.location :global(.collapse.button){width:25px;height:25px;margin-left:-5px}.code-context{overflow:hidden;margin:7px 0 13px;border-radius:6px;background:var(--surface-muted);font:9px/21px ui-monospace,SFMono-Regular,Consolas,monospace}.code-line,.omitted{display:grid;grid-template-columns:38px minmax(0,1fr)}.code-line>span,.omitted>span:first-child{padding-right:9px;color:var(--text-faint);text-align:right;user-select:none}.code-line pre{overflow:hidden;margin:0;padding:0 10px;color:var(--text-muted);text-overflow:ellipsis;white-space:pre}.code-line.selected{background:color-mix(in srgb,var(--brand-soft) 62%,transparent)}.code-line.selected>span{box-shadow:inset 2px 0 var(--brand);color:var(--text-muted)}.code-line.added.selected{background:var(--success-soft)}.code-line.removed.selected{background:var(--danger-soft)}.omitted>span:last-child{padding-left:10px;color:var(--text-faint);font-family:inherit;font-style:italic}.conversation{display:grid;gap:15px}.entry{min-width:0}.meta{display:flex;align-items:center;gap:7px;min-height:25px}.meta :global(.user-profile-link){font-size:10px}.actions{display:flex;align-items:center;gap:2px;margin-left:auto}.entry-body{padding:8px 0 0 32px}.deleted{margin:0;color:var(--text-faint);font-size:10px;font-style:italic}.entry footer,.reply-composer footer{display:flex;justify-content:flex-end;gap:6px;margin-top:7px}:global(.reply.button){width:max-content;margin-left:27px}.reply-composer{padding-left:32px}.inline .location{margin-bottom:5px}.inline .conversation{gap:12px}
  @media(max-width:600px){.thread{padding-inline:0}.thread.inline{margin-inline:6px;padding-inline:9px}.entry-body,.reply-composer{padding-left:0}.location{flex-wrap:wrap}.thread-actions{margin-left:0}}
</style>
