...
<style>
  .modal-layer{position:fixed;z-index:120;inset:0;display:flex;align-items:flex-start;justify-content:center;overflow-y:auto;padding:12vh 20px 30px;background:rgb(0 0 0/.62);backdrop-filter:blur(3px)}.modal{width:min(480px,100%);overflow:visible;border:0;border-radius:14px;background:var(--surface-raised);box-shadow:0 28px 90px rgb(0 0 0/.55)}header{padding:24px 24px 20px}h2{margin:0;color:var(--text-strong);font-size:20px;letter-spacing:-.015em}p{margin:6px 0 0;color:var(--text-muted);font-size:13px;line-height:1.5}.content{padding:0 24px 24px}.modal>footer{display:flex;justify-content:flex-end;gap:7px;flex-wrap:wrap;padding:0 24px 24px}
</style>
