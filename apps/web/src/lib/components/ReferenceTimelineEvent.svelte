...
<style>
  .reference-event{display:grid;grid-template-columns:10px minmax(0,1fr);align-items:start;gap:9px;padding:3px 5px}.mark{width:5px;height:5px;margin-top:7px;border-radius:50%;background:var(--brand)}p{min-width:0;margin:0;color:var(--text-muted);font-size:10px;line-height:1.55}a{color:var(--text-strong);font-weight:650;text-decoration:none}a:hover{text-decoration:underline}p>span{color:var(--text-faint)}p :global(time){margin-left:4px}
</style>
