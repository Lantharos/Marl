...
<style>
  .activity{padding:6px;border-radius:12px;background:var(--surface)}.activity>article{position:relative;display:grid;grid-template-columns:28px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:68px;padding:12px;border-radius:8px;color:inherit}.activity>article:hover{background:var(--surface-hover)}.mark{display:grid;width:26px;height:26px;place-items:center;border-radius:50%;background:var(--surface-muted);color:var(--text-faint)}.activity .commit-title,.activity small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.activity .commit-title{color:var(--text-strong);font-size:13px;font-weight:650;text-decoration:none}.activity .commit-title::after{position:absolute;z-index:0;inset:0;content:''}.activity small{display:flex;flex-wrap:wrap;align-items:center;gap:3px;margin-top:3px;color:var(--text-faint);font-size:11px}.activity small :global(.user-profile-link){position:relative;z-index:1;color:var(--text-muted);font-size:11px}.activity small :global(time){font-size:inherit}.activity code{color:var(--text-faint);font-size:11px}.activity>p{margin:0;padding:20px 12px;color:var(--text-faint);font-size:11px}
</style>
