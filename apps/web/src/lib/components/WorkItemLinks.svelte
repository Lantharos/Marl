...
<style>
  .linked-work{padding:1px 0}header{color:var(--text-muted);font-size:10px;font-weight:630}.linked-work>div{display:grid;gap:3px;margin-top:8px}a{display:grid;grid-template-columns:18px minmax(0,1fr);align-items:start;gap:5px;padding:5px 3px;border-radius:5px;color:inherit;text-decoration:none}a:hover{background:var(--surface-hover)}.state{display:grid;height:18px;place-items:center;color:var(--success)}.state.closed{color:var(--text-faint)}.state.merged{color:#9670d1}strong,small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}strong{color:var(--text-strong);font-size:10px;font-weight:650}small{margin-top:2px;color:var(--text-faint);font-size:9px}i{grid-column:2;color:var(--text-faint);font-size:9px;font-style:normal}
</style>
