            ...
            <article class="pull-row {signal.tone}">
              ...
              <div class="pull-copy">
                ...
                <div class="revision">
                  ...
                  <span class:failed={pull.checkSummary.failed > 0} class:running={pull.checkSummary.running > 0}>
                    ...
                    {:else}<CircleDot size={12} />No checks{/if}
                  </span>
                </div>
              </div>
            </article>
