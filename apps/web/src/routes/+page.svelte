...
<main class="page">
  <header class="hello"><div><h1>Hey, Kristof.</h1><p>{#if attentionCount > 0}{attentionCount} {attentionCount === 1 ? 'thing needs' : 'things need'} you.{:else}You’re clear for now.{/if}</p></div><div class="quick"><a href="/repositories/new"><Plus size={14} />Repository</a><a href="/pulls/new"><GitPullRequest size={14} />Pull request</a></div></header>
