...
<section class="history">
  ...
  {#each workflow.runs as run (run.id)}
    <a href="/{owner}/{repo}/runs/{run.number}">
      <span class="state {run.state}">{#if awaitingCheckApproval(run)}<ShieldCheck size={15} />{:else if ['queued', 'running'].includes(run.state)}<CircleDot size={15} />{:else if run.state === 'success'}<CircleCheck size={15} />{:else}<CircleAlert size={15} />{/if}</span>
      ...
      <span class="result">{runStateLabel(run)}</span>
    </a>
...
<style>
  .workflow-head{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;margin-bottom:22px}.title{display:flex;align-items:center;gap:10px;margin-top:14px}.title>span{display:grid;width:34px;height:34px;place-items:center;border-radius:8px;background:var(--brand-soft);color:var(--brand)}h1{margin:0;color:var(--text-strong);font-size:21px;letter-spacing:-.025em}.title p{display:flex;align-items:center;gap:5px;margin:4px 0 0;color:var(--text-faint);font-family:"SFMono-Regular",Consolas,monospace;font-size:11px}.run,.confirm,.secondary{display:inline-flex;height:31px;align-items:center;justify-content:center;gap:6px;padding:0 10px;border-radius:5px;cursor:pointer;font-size:11px;font-weight:650}.run,.confirm{border:1px solid transparent;background:var(--brand);color:white}.run:disabled{cursor:not-allowed;opacity:.45}.secondary{border:1px solid var(--border);background:var(--surface);color:var(--text)}.definition{display:flex;align-items:center;gap:30px;min-height:53px;padding:0 4px;border-top:1px solid var(--border);border-bottom:1px solid var(--border)}.definition>div{display:flex;align-items:center;gap:9px;color:var(--text-muted);font-size:11px}.definition strong{color:var(--text-faint);font-size:11px;font-weight:550}.definition code{color:var(--text-muted);font-size:11px}.trigger-list{display:flex;gap:10px}.trigger-list>span{display:inline-flex;align-items:center;gap:4px}.invalid{display:flex;align-items:flex-start;gap:9px;margin-top:18px;padding:12px;color:var(--danger);background:var(--danger-soft);border-radius:7px}.invalid strong{font-size:11px}.invalid p{margin:4px 0 0;color:var(--text-muted);font-size:11px}.error{color:var(--danger);font-size:11px}.history{margin-top:28px}.history>header{display:flex;align-items:center;justify-content:space-between;padding-bottom:9px;border-bottom:1px solid var(--border)}.history h2{margin:0;color:var(--text-strong);font-size:13px}.history header span{color:var(--text-faint);font-size:11px}.history>a{display:grid;grid-template-columns:24px minmax(0,1fr) 220px max-content;align-items:center;gap:9px;min-height:61px;padding:7px 4px;border-bottom:1px solid var(--border-subtle);color:inherit;text-decoration:none}.history>a:hover{background:var(--surface-hover)}.state{display:grid;place-items:center;color:var(--text-faint)}.state.queued,.state.running{color:var(--brand)}.state.success{color:var(--success)}.state.failure,.state.canceled{color:var(--danger)}.run-main strong,.run-main small{display:block}.run-main strong{color:var(--text-strong);font-size:11px}.run-main small{margin-top:3px;color:var(--text-faint);font-size:11px}.ref{display:flex;align-items:center;gap:5px;color:var(--text-muted);font-size:11px}.ref code{margin-left:5px;color:var(--text-faint)}.result{color:var(--text-muted);font-size:11px;text-align:right;text-transform:capitalize}.empty{padding:55px 10px;text-align:center}.empty strong{color:var(--text-strong);font-size:11px}.empty p{margin:5px 0 0;color:var(--text-faint);font-size:11px}.dispatch-ref{display:flex;align-items:center;gap:7px;padding:10px;border-radius:6px;background:var(--surface);color:var(--text-muted);font-size:11px}.dispatch-ref code{margin-left:auto;color:var(--text-faint)}@media(max-width:700px){.workflow-head{align-items:flex-start}.definition{align-items:flex-start;flex-direction:column;gap:10px;padding:12px 4px}.history>a{grid-template-columns:22px minmax(0,1fr) 112px}.ref{grid-column:2}.result{grid-column:3;grid-row:1}.trigger-list{flex-wrap:wrap}}
</style>
