...
<style>
  .page{width:100%;margin:0}.catalog{display:grid;gap:4px;padding:6px;border-radius:12px;background:var(--surface)}.workflow{display:grid;grid-template-columns:36px minmax(0,1fr) 220px;align-items:center;gap:12px;min-height:84px;padding:14px;border-radius:8px;color:inherit;text-decoration:none;transition:background-color 120ms ease}.workflow:hover{background:var(--surface-hover)}.workflow-icon{display:grid;width:32px;height:32px;place-items:center;border-radius:8px;background:var(--brand-soft);color:var(--brand)}.workflow-icon.invalid{background:var(--danger-soft);color:var(--danger)}.identity{min-width:0}.identity>strong{display:block;overflow:hidden;color:var(--text-strong);font-size:13px;text-overflow:ellipsis;white-space:nowrap}.path{display:flex;align-items:center;gap:5px;margin-top:4px;color:var(--text-faint);font-family:"SFMono-Regular",Consolas,monospace;font-size:11px}.triggers{display:flex;flex-wrap:wrap;gap:12px;margin-top:7px}.triggers>span{display:inline-flex;align-items:center;gap:4px;padding:2px 0;color:var(--text-muted);font-size:11px}.latest{display:grid;grid-template-columns:22px minmax(0,1fr);align-items:center;gap:7px;min-width:0}.latest strong,.latest small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.latest strong{color:var(--text-muted);font-size:11px;font-weight:600;text-transform:capitalize}.latest small{margin-top:3px;color:var(--text-faint);font-size:11px}.run-state{display:grid;color:var(--text-faint);place-items:center}.run-state.queued,.run-state.running{color:var(--brand)}.run-state.success{color:var(--success)}.run-state.failure,.run-state.canceled{color:var(--danger)}.empty{display:grid;justify-items:center;padding:72px 20px;color:var(--text-faint);text-align:center}.empty strong{margin-top:12px;color:var(--text-strong);font-size:12px}.empty p{max-width:380px;margin:6px 0 0;font-size:11px;line-height:1.55}@media(max-width:700px){.workflow{grid-template-columns:32px minmax(0,1fr);padding-inline:5px}.latest{grid-column:2}.workflow-icon{width:28px;height:28px}}
</style>
