...
<header class="commit-head">
  ...
  <div class="meta"><UserAvatar name={commit.author} src={commit.authorAvatarUrl} size={24} /><strong>{commit.author}</strong><span>&lt;{commit.authorEmail}&gt;</span><Time value={commit.authoredAt} />{#if commit.signatureStatus === 'verified'}<i><BadgeCheck size={13} />Verified</i>{/if}</div>
...
<style>
  .commit-head{position:relative;padding:5px 0 22px;border-bottom:1px solid var(--border)}.heading{display:flex;align-items:flex-start;gap:9px;color:var(--brand)}.heading h1{max-width:790px;margin:0;color:var(--text-strong);font-size:20px;font-weight:660;letter-spacing:-.025em}.heading p{max-width:760px;margin:8px 0 0;color:var(--text-muted);font-size:11px;line-height:1.55;white-space:pre-wrap}.meta{display:flex;align-items:center;gap:6px;margin-top:14px;color:var(--text-faint);font-size:9px}.avatar{display:grid;width:24px;height:24px;place-items:center;border-radius:50%;background:#d5b496;color:#3d2518;font-size:8px;font-weight:740}.meta strong{color:var(--text-strong)}.meta i{display:flex;align-items:center;gap:3px;color:var(--success);font-style:normal}.identity{position:absolute;top:0;right:0;display:flex;max-width:310px;border:1px solid var(--border);border-radius:6px}.identity code{overflow:hidden;padding:8px;color:var(--text-muted);font-size:8px;text-overflow:ellipsis}.identity button{display:grid;min-width:34px;place-items:center;border:0;border-left:1px solid var(--border);background:transparent;color:var(--text-muted);cursor:pointer}.parents{display:flex;gap:12px;margin-top:13px}.parents a{color:var(--brand);font-size:9px;text-decoration:none}.parents a:last-child{margin-left:auto}.renames{display:flex;flex-wrap:wrap;gap:8px;margin-bottom:12px}.renames span{display:flex;align-items:center;gap:6px;color:var(--text-faint);font-size:9px}.renames code{color:var(--text-muted)}.empty{padding:50px 0;border-top:1px solid var(--border-subtle);color:var(--text-faint);text-align:center}.empty strong{color:var(--text-strong);font-size:12px}.empty p{font-size:10px}@media(max-width:760px){.identity{position:static;width:100%;max-width:none;margin-top:14px}.meta{flex-wrap:wrap}.parents a:last-child{margin-left:0}}
</style>
