...
<style>
  ...
  .repo-bar{--repo-head-height:64px;background:linear-gradient(to bottom,var(--surface) 0 var(--repo-head-height),var(--canvas) var(--repo-head-height))}.repo-bar nav a.active{background-color:var(--surface);background-image:none;box-shadow:none;transform:none}.repo-bar nav a.active::before,.repo-bar nav a.active::after{top:0;bottom:auto;width:11px;height:11px}.repo-bar nav a.active::before{left:-11px;border-radius:0 11px 0 0;box-shadow:4px -4px 0 4px var(--surface)}.repo-bar nav a.active::after{right:-11px;border-radius:11px 0 0;box-shadow:-4px -4px 0 4px var(--surface)}
