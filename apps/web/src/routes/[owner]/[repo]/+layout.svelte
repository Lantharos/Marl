...
<style>
  ...
  .repo-bar{--repo-head-height:64px;position:relative;border-bottom:0;background:linear-gradient(to bottom,var(--surface) 0 var(--repo-head-height),var(--canvas) var(--repo-head-height))}.repo-bar::after{position:absolute;z-index:0;top:var(--repo-head-height);right:0;left:0;border-top:1px solid var(--border-subtle);content:'';pointer-events:none}.repo-bar nav{z-index:1}.repo-bar nav a{z-index:2}.repo-bar nav a.active{height:40px;margin:0;padding-bottom:0;border-radius:0;background:transparent;background-image:none;box-shadow:none;transform:none}.repo-bar nav a.active::before,.repo-bar nav a.active::after{display:none}.active-island{position:absolute;z-index:1;top:0;left:0;width:var(--island-width);height:42px;border:1px solid var(--border-subtle);border-top:0;border-radius:0 0 13px 13px;background:var(--surface);transform:translate3d(var(--island-x),0,0);pointer-events:none;will-change:width,transform}.active-island.ready{transition:width 240ms cubic-bezier(.22,1,.36,1),transform 280ms cubic-bezier(.22,1,.36,1)}.active-island::before,.active-island::after{position:absolute;top:0;width:11px;height:11px;background:transparent;content:''}.active-island::before{left:-10px;border-top:1px solid var(--border-subtle);border-right:1px solid var(--border-subtle);border-radius:0 11px 0 0;box-shadow:4px -4px 0 4px var(--surface)}.active-island::after{right:-10px;border-top:1px solid var(--border-subtle);border-left:1px solid var(--border-subtle);border-radius:11px 0 0;box-shadow:-4px -4px 0 4px var(--surface)}.repository-content{padding-top:27px}
