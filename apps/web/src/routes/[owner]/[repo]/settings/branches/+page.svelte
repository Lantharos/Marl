...
<style>
  .page-head{margin-bottom:22px}.page-head h2{margin:0;color:var(--text-strong);font-size:24px}.page-head p,section header p,.methods p{margin:6px 0 0;color:var(--text-muted);font-size:12px}.notice,.error{display:flex;align-items:center;gap:7px;margin:0 0 15px;font-size:12px}.notice{color:var(--success)}.error{color:var(--danger)}section{border-radius:12px;background:var(--surface);box-shadow:var(--shadow-surface)}section>header{padding:16px;}h3{margin:0;color:var(--text-strong);font-size:15px}.fields{display:grid;grid-template-columns:1fr 170px;gap:14px;padding:16px}.fields label>span,.required-checks label>span{display:block;margin-bottom:7px;color:var(--text);font-size:12px;font-weight:620}.required-checks{padding:0 16px 16px}.required-checks textarea{width:100%;min-height:82px;resize:vertical;padding:10px;border:1px solid var(--border);border-radius:8px;outline:0;background:var(--canvas);color:var(--text-strong);font-family:monospace;font-size:12px;line-height:1.5}.required-checks textarea:focus{border-color:var(--brand)}.required-checks small{display:block;margin-top:6px;color:var(--text-muted);font-size:11px}.requirements{display:grid;gap:4px;padding:6px 16px 16px}.methods{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;padding:16px;}.methods strong{color:var(--text-strong);font-size:12px}.methods>div:last-child{display:flex;gap:16px}section footer{display:flex;justify-content:flex-end;padding:12px 16px;background:var(--surface-muted)}@media(max-width:580px){.fields{grid-template-columns:1fr}.methods{flex-direction:column}.methods>div:last-child{flex-wrap:wrap}}
</style>
