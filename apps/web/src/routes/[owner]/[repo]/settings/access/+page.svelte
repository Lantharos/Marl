...
<style>
  .page-head{padding-bottom:22px;}h2{margin:0;color:var(--text-strong);font-size:22px}p{margin:6px 0 0;color:var(--text-muted);font-size:11px;line-height:1.5}section{padding:25px 0;}section>header{display:flex;align-items:center;justify-content:space-between;gap:20px}h3{margin:0;color:var(--text-strong);font-size:13px}.access-list{margin-top:13px}.access-list article{display:grid;grid-template-columns:32px minmax(0,1fr) 150px 32px;align-items:center;gap:10px;min-height:54px;}.person-link{grid-column:1/3}.team-avatar{display:grid;width:28px;height:28px;place-items:center;border-radius:8px;background:var(--brand-soft);color:var(--brand-strong);font-size:11px;font-weight:750}article strong,article small{display:block}article strong{color:var(--text-strong);font-size:11px}article small{margin-top:2px;color:var(--text-faint);font-size:11px}.role-select{width:150px}.empty{padding:16px 0}.error{padding:9px;border-radius:8px;background:var(--danger-soft);color:var(--danger)}.dialog-form,.dialog-form label{display:grid;gap:8px}.dialog-form{gap:16px}.dialog-form label>span{color:var(--text-strong);font-size:11px;font-weight:620}
</style>
