...
<style>
  .page-head{padding-bottom:22px;border-bottom:1px solid var(--border-subtle)}h2{margin:0;color:var(--text-strong);font-size:22px}p{margin:6px 0 0;color:var(--text-muted);font-size:10px;line-height:1.5}section{padding:25px 0;border-bottom:1px solid var(--border-subtle)}section>header{display:flex;align-items:center;justify-content:space-between;gap:20px}h3{margin:0;color:var(--text-strong);font-size:13px}button{display:inline-flex;height:33px;align-items:center;justify-content:center;padding:0 10px;border:1px solid var(--border);border-radius:6px;background:var(--surface);color:var(--text);cursor:pointer;font-size:10px;font-weight:620}button:hover{background:var(--surface-muted)}button.primary{border-color:var(--brand);background:var(--brand);color:white}.access-list{margin-top:13px}.access-list article{display:grid;grid-template-columns:32px minmax(0,1fr) 150px 32px;align-items:center;gap:10px;min-height:54px;border-top:1px solid var(--border-subtle)}.avatar,.team-avatar{display:grid;width:28px;height:28px;place-items:center;border-radius:50%;background:#d5b496;color:#3d2518;font-size:9px;font-weight:750}.team-avatar{border-radius:6px;background:var(--brand-soft);color:var(--brand-strong)}article strong,article small{display:block}article strong{color:var(--text-strong);font-size:10px}article small{margin-top:2px;color:var(--text-faint);font-size:9px}.role-select{width:150px}.access-list article>button{width:30px;padding:0;border-color:transparent;background:transparent;color:var(--danger)}.empty{padding:16px 0}.error{padding:9px;border-radius:6px;background:var(--danger-soft);color:var(--danger)}.dialog-form,.dialog-form label{display:grid;gap:8px}.dialog-form{gap:16px}.dialog-form label>span{color:var(--text-strong);font-size:10px;font-weight:620}
</style>
