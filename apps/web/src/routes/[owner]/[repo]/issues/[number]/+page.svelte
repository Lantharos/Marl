...
<style>
  .issue-header{padding:2px 0 22px}.title-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:16px}.title-row h1{margin:0;color:var(--text-strong);font-size:25px;font-weight:670;letter-spacing:-.03em;line-height:1.18;text-wrap:balance}.title-row h1 span{color:var(--text-faint);font-size:16px;font-weight:540;letter-spacing:-.01em;white-space:nowrap}.issue-meta{margin:10px 0 0;color:var(--text-muted);font-size:10px}.work-motion{display:flex;min-height:38px;align-items:center;justify-content:space-between;gap:18px;margin:1px 0 29px;padding:0 3px}.work-motion>strong{display:flex;align-items:center;gap:8px;color:var(--text-strong);font-size:12px;font-weight:670}.work-motion>strong span{width:7px;height:7px;border-radius:50%;background:var(--text-faint)}.work-motion.working>strong span{background:var(--brand)}.work-motion.attention>strong span{background:var(--danger)}.work-motion.complete>strong span{background:var(--success)}.motion-action{padding:6px 7px;border-radius:5px;color:var(--brand);font-size:10px;font-weight:650;text-decoration:none}.motion-action:hover{background:var(--surface-hover);color:var(--brand-hover)}.work-layout{display:grid;grid-template-columns:minmax(0,1fr) 270px;align-items:start;gap:46px}.brief>header,.activity>header{display:flex;align-items:flex-start;justify-content:space-between;gap:14px}.brief h2,.activity h2{margin:0;color:var(--text-strong);font-size:14px;font-weight:670}.brief-body{padding:18px 0 4px;font-size:12px;line-height:1.65}.activity{padding-top:50px}.timeline{display:grid;gap:21px;padding-top:17px}.comment{padding:3px 4px 8px;content-visibility:auto;contain-intrinsic-size:auto 120px}.comment>header{display:flex;align-items:center;gap:6px;min-height:28px;color:var(--text-muted);font-size:10px}.comment>header :global(.user-profile-link){font-size:10px}.comment>div{padding:10px 0 0 33px}.comment footer,.composer>footer{display:flex;justify-content:flex-end;gap:6px;margin-top:10px}:global(.end){margin-left:auto}.comment-actions{display:flex;gap:3px;margin-left:6px}.deleted,.quiet-activity{margin:0;color:var(--text-faint);font-size:10px;font-style:italic}.quiet-activity{padding:18px 2px;font-style:normal}.event{display:grid;grid-template-columns:10px 1fr;align-items:start;gap:9px;padding:3px 5px}.event-mark{width:5px;height:5px;margin-top:7px;border-radius:50%;background:var(--text-faint)}.event p{margin:0;color:var(--text-muted);font-size:10px;line-height:1.55}.event p :global(.user-profile-link){font-size:10px}.work-reference{color:var(--text-strong);font-weight:650;text-decoration:none}.work-reference:hover{text-decoration:underline}.composer{padding-top:3px}.composer>footer{margin-top:8px}.action-error{display:grid;grid-template-columns:18px minmax(0,1fr) 30px;align-items:center;gap:6px;margin:-10px 0 14px;padding:8px 8px 8px 11px;border-left:2px solid var(--danger);border-radius:0 6px 6px 0;background:var(--danger-soft);color:var(--danger);font-size:10px}.timeline :global(.older.button){height:auto;min-height:36px;background:var(--surface-muted);font-size:9px}.editor{display:grid;gap:14px}.editor label>span{display:block;margin-bottom:6px;color:var(--text-muted);font-size:9px;font-weight:620}.editor input{width:100%;height:38px;padding:0 10px;border:1px solid var(--border);border-radius:7px;outline:0;background:var(--surface);color:var(--text-strong);font-size:11px}.editor input:focus{border-color:var(--brand)}aside{position:sticky;top:68px}@media(max-width:860px){.work-layout{grid-template-columns:1fr;gap:42px}aside{position:static}}@media(max-width:600px){.title-row{grid-template-columns:1fr}.title-row>:global(.button){justify-self:start}.title-row h1{font-size:21px}.title-row h1 span{font-size:14px}.brief>header,.activity>header{display:grid}.comment>div{padding-left:0}}
</style>
