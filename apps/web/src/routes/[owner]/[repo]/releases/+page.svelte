...
<style>
  .page{width:min(920px,100%);margin:0 auto}.list{border-top:1px solid var(--border-subtle)}article{display:grid;grid-template-columns:34px minmax(0,1fr);gap:12px;padding:20px 0;border-bottom:1px solid var(--border-subtle)}.marker{display:grid;width:30px;height:30px;border-radius:50%;background:var(--brand-soft);color:var(--brand);place-items:center}.title{display:flex;align-items:center;gap:7px;flex-wrap:wrap}.title>a{color:var(--text-strong);font-size:14px;font-weight:650;text-decoration:none}.title>a:hover{color:var(--brand)}.title span{color:var(--text-faint);font-size:9px;font-weight:650}.title .latest{color:var(--brand)}.meta{display:flex;align-items:center;gap:5px;margin-top:6px;color:var(--text-faint);font-size:9px;flex-wrap:wrap}.meta code,.meta>a{color:var(--text-muted);text-decoration:none}.content>p{max-width:720px;margin:11px 0 0;color:var(--text-muted);font-size:11px;line-height:1.55}.foot{display:flex;align-items:center;gap:5px;margin-top:12px;color:var(--text-faint);font-size:9px}.empty{padding:64px 20px;text-align:center;color:var(--text-faint)}.empty strong{display:block;margin-top:12px;color:var(--text-strong);font-size:13px}.empty p{margin:6px 0 13px;font-size:10px}.empty a{color:var(--brand);font-size:10px;text-decoration:none}.error{color:var(--danger);font-size:10px;text-align:center}.page :global(.more.button){display:flex;margin:18px auto 0}@media(max-width:620px){article{grid-template-columns:28px 1fr}.marker{width:26px;height:26px}}
</style>
