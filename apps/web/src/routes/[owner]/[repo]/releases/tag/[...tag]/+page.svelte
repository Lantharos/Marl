...
<style>
  .page{width:min(920px,100%);margin:0 auto}.page>header{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;padding-bottom:26px;border-bottom:1px solid var(--border-subtle)}.heading{display:flex;min-width:0;gap:13px}.tag-icon{display:grid;width:38px;height:38px;flex:0 0 auto;border-radius:50%;background:var(--brand-soft);color:var(--brand);place-items:center}.status{display:flex;gap:7px;min-height:14px}.status span{color:var(--text-faint);font-size:9px;font-weight:650}.status .latest{color:var(--brand)}h1{margin:3px 0 0;color:var(--text-strong);font-size:27px;letter-spacing:-.035em}.meta{display:flex;align-items:center;gap:5px;margin-top:8px;color:var(--text-faint);font-size:9px;flex-wrap:wrap}.meta code,.meta>a{color:var(--text-muted);text-decoration:none}.notes{min-height:120px;padding:28px 0}.notes>p{color:var(--text-faint);font-size:11px}.source{margin-top:25px;padding-top:24px;border-top:1px solid var(--border-subtle)}.source>header{display:flex;align-items:flex-start;justify-content:space-between;color:var(--text-faint)}h2{margin:0;color:var(--text-strong);font-size:16px}.source header p{margin:5px 0 0;font-size:10px}.source>div{display:grid;margin-top:15px;border-top:1px solid var(--border-subtle)}.source>div>a{display:flex;min-height:54px;align-items:center;gap:10px;border-bottom:1px solid var(--border-subtle);color:var(--text-muted);text-decoration:none}.source>div>a:hover{color:var(--brand)}.source a span{display:block}.source strong,.source small{display:block}.source strong{color:var(--text-strong);font-size:11px}.source small{margin-top:3px;color:var(--text-faint);font-size:9px}.back{display:inline-block;margin-top:24px;color:var(--text-muted);font-size:10px;text-decoration:none}.back:hover{color:var(--brand)}@media(max-width:620px){.page>header{flex-wrap:wrap}.tag-icon{width:32px;height:32px}h1{font-size:23px}}
</style>
