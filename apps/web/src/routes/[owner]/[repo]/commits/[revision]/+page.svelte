...
<style>
  .page-head{display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:26px}.page-head h1{margin:0;color:var(--text-strong);font-size:22px;letter-spacing:-.025em}.page-head p{margin:6px 0 0;color:var(--text-muted);font-size:10px}.page-head p strong,.page-head code{color:var(--text-strong)}.history{display:grid;gap:25px}.history section{display:grid;grid-template-columns:105px minmax(0,1fr);align-items:start}.history h2{position:sticky;top:82px;margin:12px 0 0;color:var(--text-muted);font-size:10px;font-weight:600}.commit-list{border-block:1px solid var(--border)}article{display:grid;grid-template-columns:22px 30px minmax(0,1fr) auto auto;align-items:center;gap:10px;min-height:66px;padding:9px 10px;border-top:1px solid var(--border-subtle)}article:first-child{border-top:0}.mark{display:grid;color:var(--text-faint)}.commit-copy{min-width:0}.commit-copy>a{display:block;overflow:hidden;color:var(--text-strong);font-size:11px;font-weight:640;text-decoration:none;text-overflow:ellipsis;white-space:nowrap}.commit-copy>a:hover{color:var(--brand)}.commit-copy p{display:flex;align-items:center;gap:3px;margin:4px 0 0;color:var(--text-faint);font-size:9px}.commit-copy p :global(.user-profile-link){color:var(--text-muted)}.verified{display:flex;align-items:center;gap:4px;color:var(--success);font-size:9px}.sha{padding:5px 7px;border:1px solid var(--border);border-radius:5px;color:var(--text-muted);font:9px ui-monospace,SFMono-Regular,Consolas,monospace;text-decoration:none}.sha:hover{background:var(--surface-hover);color:var(--text-strong)}.empty{display:grid;min-height:220px;place-content:center;justify-items:center;color:var(--text-faint);text-align:center}.empty strong{margin-top:9px;color:var(--text-strong);font-size:12px}.empty p{margin:5px 0;font-size:10px}@media(max-width:700px){.history section{grid-template-columns:1fr}.history h2{position:static;margin:0 0 8px}.verified{display:none}article{grid-template-columns:20px 28px minmax(0,1fr) auto}}@media(max-width:480px){.page-head{align-items:flex-start}.page-head p strong{display:none}.mark{display:none}article{grid-template-columns:28px minmax(0,1fr) auto}.sha{font-size:0}.sha::after{font-size:9px;content:'View'}}
