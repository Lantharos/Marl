<script lang="ts">
  ...
  type Commit = { id: string; shortId: string; title: string; author: string; authorAvatarUrl?: string | null; signatureStatus: string };
...
{#if finderOpen}
  <div class="finder-layer" role="presentation" onclick={(event) => event.currentTarget === event.target && (finderOpen = false)}>
    <div class="finder" role="dialog" aria-modal="true" aria-label="Go to file">
      <header><Search size={17} /><input bind:this={finderInput} value={fileQuery} oninput={(event) => searchFiles(event.currentTarget.value)} placeholder="Search files in this repository" /><button aria-label="Close file finder" onclick={() => (finderOpen = false)}><X size={16} /></button></header>
...
<style>
  .code-page{width:min(1120px,100%);margin:0 auto}.toolbar{display:flex;align-items:center;justify-content:space-between;margin-bottom:12px}.branch-group{display:flex;align-items:center;gap:7px}.branch-anchor{position:relative}.toolbar button,.branch-group>a{display:inline-flex;height:34px;align-items:center;gap:6px;padding:0 10px;border:1px solid var(--border);border-radius:7px;background:var(--surface);color:var(--text);font-size:11px;font-weight:590;text-decoration:none;cursor:pointer}.toolbar button:hover,.branch-group>a:hover{background:var(--surface-muted);color:var(--text-strong)}.branch-group>a{border-color:transparent;background:transparent;color:var(--text-muted)}.branch-button{min-width:106px;justify-content:flex-start}.branch-button span{flex:1;text-align:left}.branch-menu{position:absolute;top:40px;left:0;z-index:20;width:290px;padding:6px;border:1px solid var(--border-strong);border-radius:9px;background:var(--surface);box-shadow:var(--shadow-card)}.branch-menu label{display:flex;align-items:center;gap:6px;height:31px;margin-bottom:4px;padding:0 8px;border:1px solid var(--border);border-radius:6px;color:var(--text-faint)}.branch-menu input{min-width:0;flex:1;border:0;outline:0;background:transparent;color:var(--text-strong);font-size:10px}.branch-menu>button{display:flex;width:100%;height:auto;min-height:46px;justify-content:space-between;border:0}.branch-menu>button.chosen{background:var(--brand-soft);color:var(--brand)}.branch-menu strong,.branch-menu small{display:block;text-align:left}.branch-menu strong{color:var(--text-strong);font-size:11px}.branch-menu small{margin-top:3px;color:var(--text-faint);font-size:9px}.branch-menu>p{margin:0;padding:16px 8px;color:var(--text-faint);font-size:10px;text-align:center}.browser{overflow:hidden;border:1px solid var(--border);border-radius:9px;background:var(--surface);box-shadow:var(--shadow-subtle)}.browser>header{display:grid;grid-template-columns:27px minmax(0,1fr) auto auto auto;min-height:48px;align-items:center;gap:9px;padding:7px 11px;border-bottom:1px solid var(--border);background:var(--surface-muted)}.commit-copy{display:flex;min-width:0;gap:5px;overflow:hidden;font-size:11px;white-space:nowrap}.commit-copy strong{color:var(--text-strong);font-weight:630}.commit-copy span{overflow:hidden;color:var(--text-muted);text-overflow:ellipsis}.verified{display:inline-flex;align-items:center;gap:4px;color:var(--success);font-size:10px;font-weight:650}.commit-id{color:var(--text-faint);font-family:"SFMono-Regular",Consolas,monospace;font-size:9px;text-decoration:none}.history{display:inline-flex;align-items:center;gap:4px;color:var(--text-muted);font-size:10px;text-decoration:none}.file-row{display:grid;grid-template-columns:minmax(210px,.72fr) minmax(0,1.28fr);min-height:39px;align-items:center;gap:14px;padding:0 11px;border-top:1px solid var(--border-subtle);color:inherit;text-decoration:none}.file-row:first-child{border-top:0}.file-row:hover{background:var(--surface-hover)}.file-name{display:flex;min-width:0;align-items:center;gap:8px;color:var(--brand)}.file-name strong{overflow:hidden;color:var(--text-strong);font-size:11px;font-weight:570;text-overflow:ellipsis;white-space:nowrap}.file-meta{display:flex;min-width:0;align-items:center;justify-content:flex-end;gap:18px}.file-meta>span{overflow:hidden;color:var(--text-muted);font-size:10px;text-overflow:ellipsis;white-space:nowrap}:global(.file-time){flex:none;color:var(--text-faint);font-size:9px;text-align:right}.empty{margin:0;padding:30px 12px;color:var(--text-faint);font-size:10px;text-align:center}.error{margin:10px 0 0;color:var(--danger);font-size:10px}.finder-layer{position:fixed;z-index:100;inset:0;display:flex;justify-content:center;padding-top:90px;background:rgb(0 0 0/.58);backdrop-filter:blur(3px)}.finder{width:min(620px,calc(100vw - 28px));height:fit-content;max-height:min(560px,calc(100vh - 130px));overflow:hidden;border:1px solid var(--border-strong);border-radius:9px;background:var(--surface);box-shadow:var(--shadow-card)}.finder header{display:flex;align-items:center;gap:9px;padding:11px 12px;border-bottom:1px solid var(--border);color:var(--text-faint)}.finder header input{min-width:0;flex:1;border:0;outline:0;background:transparent;color:var(--text-strong);font-size:13px}.finder header button{display:grid;width:28px;height:28px;border:0;border-radius:6px;background:transparent;color:var(--text-muted);cursor:pointer;place-items:center}.finder>div{overflow-y:auto;max-height:470px;padding:6px}.finder a{display:flex;min-height:38px;align-items:center;justify-content:space-between;padding:0 9px;border-radius:6px;color:var(--text);font-size:11px;text-decoration:none}.finder a:hover{background:var(--brand-soft)}.finder a span{display:flex;align-items:center;gap:7px}.finder a small{color:var(--text-faint);font-size:9px}@media(max-width:680px){.branch-group>a{width:34px;justify-content:center;padding:0}.branch-group>a span{display:none}.browser>header{grid-template-columns:27px minmax(0,1fr) auto auto}.commit-id{display:none}.file-row{grid-template-columns:minmax(0,1fr) auto}.file-meta>span{display:none}}
</style>
