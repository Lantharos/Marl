...
{#if userProfile}
  <main class="profile-page">
    ...
    <div class="work">
      ...
      <div class="columns"><section><header><h2>Public repositories</h2><a href="/{canonicalIdentity}/-/repositories">All repositories</a></header><ProfileRepositoryList repositories={data.repositories.slice(0, 7)} /></section><section><header><h2>Recent work</h2></header><ProfileActivity activity={data.activity} /></section></div>
    </div>
  </main>
