...
<style>
  .page{width:min(1080px,calc(100% - 56px));margin:0 auto;padding:48px 0 72px}.summary{display:flex;gap:18px;margin-bottom:9px;color:var(--text-muted);font-size:12px}.summary span{display:inline-flex;align-items:center;gap:5px}.summary strong{color:var(--text)}.summary .warn{color:var(--danger)}.row{display:grid;grid-template-columns:38px minmax(160px,1fr) minmax(120px,auto) 100px 72px;align-items:center;gap:12px;min-height:78px;padding:10px 5px;border-bottom:1px solid var(--border-subtle);color:inherit;text-decoration:none}.row:hover{background:var(--surface-hover)}.machine{display:grid;width:34px;height:34px;place-items:center;color:var(--text)}.identity strong,.identity small{display:block}.identity strong{color:var(--text-strong);font-size:14px}.identity small{margin-top:4px;color:var(--text-muted);font-size:12px}.labels{display:flex;flex-wrap:wrap;gap:5px}.labels code{padding:3px 6px;border-radius:4px;background:var(--surface-muted);color:var(--text);font-size:11px}.capacity{display:grid;grid-template-columns:36px 1fr;align-items:center;gap:7px;color:var(--text-muted);font-size:11px}.capacity b{font-weight:500}.capacity>i{overflow:hidden;height:4px;background:var(--surface-muted)}.capacity>i span{display:block;height:100%;background:var(--brand)}.status{display:flex;align-items:center;gap:6px;color:var(--text);font-size:12px;text-transform:capitalize}.status>i{width:7px;height:7px;border-radius:50%;background:var(--success)}.status.busy>i{background:var(--brand)}.status.offline{color:var(--danger)}.status.offline>i{background:var(--danger)}.empty{padding:70px 4px;color:var(--text-muted);text-align:center}.empty strong{display:block;margin-top:10px;color:var(--text-strong);font-size:15px}.empty p{margin:7px 0 0;font-size:12px}.empty a{display:inline-flex;margin-top:16px;color:var(--brand-strong);font-size:12px;text-decoration:none}@media(max-width:760px){.page{width:calc(100% - 28px);padding-top:32px}.row{grid-template-columns:38px minmax(0,1fr) 70px}.labels,.capacity{display:none}}
</style>
