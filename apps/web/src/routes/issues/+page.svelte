...
<style>.page{width:min(960px,calc(100% - 48px));margin:0 auto;padding:42px 0 72px}.load-error{margin:16px 0 0;color:var(--danger);font-size:10px;text-align:center}.page :global(.load.button){display:flex;margin:18px auto 0}@media(max-width:680px){.page{width:calc(100% - 28px);padding-top:28px}}</style>
