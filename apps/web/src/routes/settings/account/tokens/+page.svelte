...
<style>
  .page-head{display:flex;align-items:center;justify-content:space-between;gap:20px;padding-bottom:25px;border-bottom:1px solid var(--border-subtle)}h2{margin:0;color:var(--text-strong);font-size:23px;letter-spacing:-.03em}.page-head p{margin:6px 0 0;color:var(--text-muted);font-size:10px;line-height:1.5}.token-list article{display:flex;align-items:center;justify-content:space-between;gap:18px;padding:15px 0;border-bottom:1px solid var(--border-subtle)}.token-list strong,.token-list span,.token-list small{display:block}.token-list strong{color:var(--text-strong);font-size:11px}.token-list span,.token-list small{margin-top:3px;color:var(--text-faint);font-size:9px}.empty{padding:24px 0;color:var(--text-faint);font-size:10px}.error{display:flex;align-items:center;gap:7px;padding:9px 10px;border-radius:6px;background:var(--danger-soft);color:var(--danger);font-size:10px}.token-form,.token-form label{display:grid;gap:8px}.token-form label span{color:var(--text-strong);font-size:10px;font-weight:630}.token-form input{height:37px;padding:0 9px;border:1px solid var(--border-strong);border-radius:6px;outline:0;background:var(--surface);color:var(--text-strong)}.scopes{margin:8px 0}.token-secret{display:grid;gap:12px}.token-secret code{overflow-wrap:anywhere;padding:12px;border-radius:6px;background:var(--canvas);color:var(--text-strong);font-size:10px}.token-secret :global(.button){justify-self:end}
</style>
