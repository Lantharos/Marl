<script lang="ts">
  ...
  import OrganizationSettingsShell from '$lib/components/OrganizationSettingsShell.svelte';
  ...
  let organizationName = $state(untrack(() => data.organization.name as string));
...
<OrganizationSettingsShell name={organizationName} {slug} active="access" showSecrets={canAdminister}><header class="page-head"><h2>People and teams</h2><p>Organization membership and the access inherited by every repository.</p></header>{#if notice}<p class="notice"><Check size={13} />{notice}</p>{/if}{#if error}<p class="error">{error}</p>{/if}
...
<style>
  .page-head{padding-bottom:24px;border-bottom:1px solid var(--border-subtle)}h2{margin:0;color:var(--text-strong);font-size:25px;letter-spacing:-.03em}.page-head p{margin:7px 0 0;color:var(--text-muted);font-size:13px;line-height:1.5}p{margin:6px 0 0;color:var(--text-muted);font-size:12px;line-height:1.5}section{padding:24px 0;border-bottom:1px solid var(--border-subtle)}section>header{display:flex;align-items:center;justify-content:space-between;gap:18px}h3{margin:0;color:var(--text-strong);font-size:13px}button{display:inline-flex;height:36px;align-items:center;justify-content:center;padding:0 12px;border:1px solid var(--border);border-radius:6px;background:var(--surface);color:var(--text);cursor:pointer;font-size:12px;font-weight:620}button.primary{border-color:var(--brand);background:var(--brand);color:#fff}button.danger-button{border-color:var(--danger);background:var(--danger-soft);color:var(--danger)}.settings-form{display:grid;grid-template-columns:minmax(0,1fr) 230px auto;align-items:end;gap:12px}.settings-form label,.modal-form label{display:grid;gap:7px}.settings-form label>span,.modal-form label>span{color:var(--text-strong);font-size:12px;font-weight:620}input{height:38px;padding:0 10px;border:1px solid var(--border-strong);border-radius:6px;outline:0;background:var(--surface);color:var(--text-strong);font-size:13px}.list{margin-top:13px}.list article{display:grid;grid-template-columns:32px minmax(0,1fr) 150px 32px;align-items:center;gap:10px;min-height:62px;border-top:1px solid var(--border-subtle)}.list strong,.list small{display:block}.list strong{color:var(--text-strong);font-size:13px}.list small{margin-top:3px;color:var(--text-faint);font-size:11px}.list .role{grid-column:3/5;justify-self:end;color:var(--text-muted);font-size:11px}.role-select{width:150px}.list article>button{width:34px;padding:0;border-color:transparent;background:transparent;color:var(--danger)}.list article.invitation{grid-template-columns:1fr 34px}.buttons{display:flex;gap:7px}.teams{display:grid;gap:8px;margin-top:14px}.teams>article{padding:14px;border-radius:6px;background:var(--surface)}.team-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.teams strong,.teams span{display:block}.teams strong{color:var(--text-strong);font-size:13px}.teams span{margin-top:4px;color:var(--text-faint);font-size:11px}.team-members{display:grid;margin-top:11px;border-top:1px solid var(--border-subtle)}.team-members>div{display:flex;min-height:40px;align-items:center;justify-content:space-between}.team-members small{color:var(--text-faint)}.team-members button{width:30px;height:30px;padding:0;border-color:transparent;background:transparent;color:var(--danger)}.modal-form{display:grid;gap:15px}.notice,.error{display:flex;align-items:center;gap:7px;padding:10px;border-radius:6px;font-size:12px}.notice{background:var(--success-soft);color:var(--success)}.error{background:var(--danger-soft);color:var(--danger)}@media(max-width:760px){.settings-form{grid-template-columns:1fr}.teams{grid-template-columns:1fr}}
</style>
