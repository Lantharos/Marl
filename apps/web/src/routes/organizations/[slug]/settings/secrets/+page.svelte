...
<OrganizationSettingsShell name={data.organizationName} {slug} avatarUrl={data.organizationAvatarUrl} active="secrets"><SecretSettings initialSecrets={data.secrets} endpoint={`/organizations/${slug}/secrets`} scope="organization" /></OrganizationSettingsShell>
