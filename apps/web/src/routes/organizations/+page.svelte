...
<style>
  .page{width:min(920px,calc(100% - 48px));margin:0 auto;padding:44px 0 80px}.org-list{display:grid;gap:4px}.org-list a{display:grid;grid-template-columns:38px minmax(0,1fr) auto;align-items:center;gap:12px;min-height:76px;padding:9px 12px;border-radius:8px;color:var(--text);text-decoration:none;transition:background-color 120ms ease}.org-list a:hover{background:var(--surface-hover)}.org-list strong,.org-list small{display:block}.org-list strong{color:var(--text-strong);font-size:13px}.org-list small{margin-top:4px;color:var(--text-faint);font-size:10px}.org-list a>span:last-child{color:var(--text-muted);font-size:10px;text-transform:capitalize}.form,.form label{display:grid;gap:8px}.form{gap:16px}.form label>span{color:var(--text-strong);font-size:12px;font-weight:620}.form input{height:38px;padding:0 9px;border:1px solid var(--border-strong);border-radius:6px;outline:0;background:var(--surface);color:var(--text-strong);font-size:13px}.form input:focus{border-color:var(--brand);box-shadow:0 0 0 3px var(--brand-soft)}.error{padding:9px;border-radius:6px;background:var(--danger-soft);color:var(--danger)}.empty{padding:64px 12px;color:var(--text-muted);text-align:center}.empty strong{color:var(--text-strong);font-size:15px}.empty p{margin:7px 0 0;font-size:12px}@media(max-width:600px){.page{width:calc(100% - 28px);padding-top:32px}.page :global(.page-header .button){font-size:0}.page :global(.page-header .button svg){margin:0}}
</style>
