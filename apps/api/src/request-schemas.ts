...
export const organizationSettingsBody = strictObject({ name: optional(pipe(string(), minLength(1), maxLength(120))), baseRepositoryRole: optional(picklist(['read', 'triage', 'write', 'maintain'])) });
