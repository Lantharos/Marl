...
export const gitIndexBody = strictObject({ repositoryId: identifier, defaultBranch: optional(branch), commits: array(unknown()), branches: array(unknown()), entries: array(unknown()) });
