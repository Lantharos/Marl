...
<section class="sty-settings-section border border-[#2a2a28] bg-[#141412]">
	<div class="sty-settings-section-header flex min-h-12 items-center justify-between gap-3 border-b px-4 transition-[background-color] hover:bg-[#181816] {expanded ? 'is-expanded border-[#252522]' : 'border-transparent'}">
