	...
	<section>
		...
		<div class="mt-4 overflow-hidden rounded border border-[#2a2a28]">
			...
			<div class="grid gap-2 border-b border-[#252522] px-4 py-3 md:grid-cols-[180px_1fr]">
				...
				<p class="text-sm leading-6 text-[#8c887e]"><code>work_new</code>, <code>work_new_isolated</code>, <code>work_switch</code>, <code>work_move</code>, <code>work_ready</code>, <code>work_merge</code>, <code>work_list</code>, and <code>work_status</code>.</p>
			</div>
			<div class="grid gap-2 border-b border-[#252522] px-4 py-3 md:grid-cols-[180px_1fr]">
